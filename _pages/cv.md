...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
  ...
  <a href="https://tinyurl.com/cv-vedant" target="_blank" style="font-size: 0.9rem;"><i class="fas fa-file-pdf"></i> Download PDF</a>
</div>

Education
======
* **Ph.D. in Computer Science**, University of South Carolina, 2021 - 2026 (expected)
  * Advisor: Amit Sheth
  * Award: Best Poster Award at DISCOVER USC 2024, "Foundation Model For Pathfinding Problems" (>500 participants)
* **M.S. in Computer Science**, University of South Carolina, 2025
  * Completed as part of direct Ph.D. program
* **B.Tech. in Computer Science & Engineering**, International Institute of Information Technology, Naya Raipur, 2020
  * Award: Institute Gold Medal for Best All-Round Performance

Work Experience
======
* **Summer Research Intern**, IBM Thomas J. Watson Research Center, May 2025 - August 2025
  * Developed a multi-agent fast–slow architecture (SOFAI-LM) with a metacognitive feedback loop to enhance LLM reasoning
  * Demonstrated that the architecture helps an LLM outperform a standalone LRM in both accuracy and speed
  * Identified that LLM history aids the LRM on local tasks (debugging) but hinders it on global tasks (graph coloring)
  * Contributed to two patent applications and the accepted AAAI'26 Lab proposal

* **Research Affiliate**, Artificial Intelligence Institute, University of South Carolina, December 2019 - July 2020
  * Developed a knowledge-infused machine learning pipeline for assessing the psychological impacts of pandemics using tweets
  * Analyzed 12 billion COVID-19 tweets to study the spatiotemporal effect of the pandemic and policy decisions
...
* **SOFAI Lab: A Hands-On Guide to Building Neurosymbolic Systems with Metacognitive Control**  
  ...
  *Vedant Khandelwal*  
  [Slides](https://docs.google.com/presentation/d/15auMRq_svm-VMpz3kwzA2hNbRxH_tlX4g6IPH_kIkGc/edit?usp=sharing)
...
* **Neuro-Symbolic AI for Deep Analysis of Social Media Big Data (Tutorial)**  
  ...
  *Vedant Khandelwal, Manas Gaur, Ugur Kursuncu, Valerie Shalin, and Amit Sheth*  
  [Slides](https://docs.google.com/presentation/d/1VBnFUfsLg7hHHB_B5MLgbyV_vcGsAMdrO2ATEgmZbXY/edit?usp=sharing) | [Website](https://aiisc.ai/smbd24/) | [pdf](https://scholarcommons.sc.edu/cgi/viewcontent.cgi?article=1336&context=csce_facpub)
...
* **Introduction to Transformers: Theory and Practical Applications**  
  ...
  *Vedant Khandelwal*  
  [Slides](https://docs.google.com/presentation/d/1YEMpKTDvEe2OczunFdHwqtkz8l3qhmEp9ngBOpWP5f4/edit?usp=sharing)

* **Foundation Models**  
  Guest Lecture at CSCE 580 - Artificial Intelligence, University of South Carolina, April 2024  
  *Vedant Khandelwal*  
  [Slides](https://docs.google.com/presentation/d/1taCqmYk9RQ-c7BRZVIKmOgsgVNr8TxW7H4J-EjMw3J8/edit?usp=sharing)
...
Patents
======
* **U.S. Patent 12,332,873** (Issued June 17, 2025)  
  "Multimodal retrieval and execution monitoring using rich recipe representation"  
  Biplav Srivastava, Vishal Pallagani, Revathy Venkataramanan, Vedant Khandelwal, and Kausik Lakkaraju

* **U.S. Patent 12,067,983** (Issued August 20, 2024)  
  "Robust useful and general task-oriented virtual assistants"  
  Biplav Srivastava, Kausik Lakkaraju, Revathy Venkataramanan, Vishal Pallagani, Vedant Khandelwal, and Hong Yung Yip
